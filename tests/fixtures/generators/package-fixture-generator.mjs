...
export class PackageFixtureGenerator {
  ...
  /**
   * 生成合法 100x100 像素 PNG 图片 Buffer
   */
  static getValid1x1PngBuffer() {
    return Buffer.from([
      0x89, 0x50, 0x4e, 0x47, 0x0d, 0x0a, 0x1a, 0x0a, 0x00, 0x00, 0x00, 0x0d, 0x49, 0x48, 0x44, 0x52,
      0x00, 0x00, 0x00, 0x64, 0x00, 0x00, 0x00, 0x64, 0x08, 0x02, 0x00, 0x00, 0x00, 0xff, 0x80, 0xbd,
      0x03, 0x00, 0x00, 0x00, 0x1f, 0x49, 0x44, 0x41, 0x54, 0x78, 0x9c, 0xed, 0xc1, 0x01, 0x01, 0x00,
      0x00, 0x00, 0x82, 0x20, 0xff, 0xaf, 0x6e, 0x48, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x1c, 0x03, 0x64, 0x00, 0x01, 0x3d, 0x8e, 0x25, 0x4b, 0x00, 0x00, 0x00, 0x00,
  ...
  static createValidPackage(outputPath, manifestOverrides = {}, themeOverrides = {}) {
    ...
    const theme = this.getDefaultThemeConfig({ id: manifest.id, ...themeOverrides });

    builder.addFile('manifest.json', JSON.stringify(manifest, null, 2));
    builder.addFile('theme.json', JSON.stringify(theme, null, 2));
    builder.addFile('background.png', this.getValid1x1PngBuffer());
