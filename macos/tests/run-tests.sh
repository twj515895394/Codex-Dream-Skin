...
"$NODE" "$ROOT/tests/runtime-api-v1-schema.test.mjs"
"$NODE" "$ROOT/tests/contract-test-runner.test.mjs"
"$NODE" "$ROOT/tests/capabilities-status-operation.test.mjs"
"$NODE" "$ROOT/tests/list-themes-operation.test.mjs"
"$NODE" "$ROOT/tests/operation-lock.test.mjs"
"$NODE" "$ROOT/tests/transaction-journal.test.mjs"
"$NODE" "$ROOT/tests/import-theme-operation.test.mjs"
"$NODE" "$ROOT/tests/apply-verify-restore-operations.test.mjs"
"$NODE" "$ROOT/tests/macos-adapter.test.mjs"
"$NODE" "$ROOT/tests/windows-adapter.test.mjs"
"$NODE" "$ROOT/tests/managed-runtime-lifecycle.test.mjs"
"$NODE" "$ROOT/tests/desktop-shell-spike.test.mjs"
"$NODE" "$ROOT/tests/vertical-slice-e2e.test.mjs"
"$NODE" "$ROOT/tests/security-hardening.test.mjs"
"$NODE" "$ROOT/tests/launcher-architecture.test.mjs"
"$NODE" "$ROOT/tests/failure-injection-matrix.test.mjs"
...
"$NODE" "$ROOT/../tests/fixtures/generators/package-fixture-generator.test.mjs"
"$NODE" "$ROOT/tests/importer-regression.test.mjs"
